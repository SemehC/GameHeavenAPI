...
namespace GameHeavenAPI.Migrations
{
    ...
    [Migration("20211116224914_GeneratedSomeMoreEntitiesPart2")]
    partial class GeneratedSomeMoreEntitiesPart2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameHeavenAPI.Entities.DirectX", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DeveloperGame", b =>
                {
                    b.HasOne("GameHeavenAPI.Entities.Developer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameHeavenAPI.Entities.Game", b =>
                {
                    ...
                    b.HasOne("GameHeavenAPI.Entities.Platform", "Platform")
                        .WithMany()
            ...
            modelBuilder.Entity("GameHeavenAPI.Entities.GameImage", b =>
                {
                    b.HasOne("GameHeavenAPI.Entities.Game", "Game")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("GameHeavenAPI.Entities.GamesCart", b =>
                {
                    b.HasOne("GameHeavenAPI.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("GameHeavenAPI.Entities.MinimumSystemRequirements", b =>
                {
                    ...
                    b.HasOne("GameHeavenAPI.Entities.DirectX", "DirectX")
                        .WithMany()
